...
// Hardcoded content for now to ensure it works
...
export default function LearnNewPage() {
  console.log('Learn NEW page rendering with hardcoded content:', new Date().toISOString());
    ...
    <div className="container mx-auto px-4 py-8 max-w-6xl">
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h1 className="text-3xl font-bold text-gray-900">Learn (NEW VERSION)</h1>
        </div>
