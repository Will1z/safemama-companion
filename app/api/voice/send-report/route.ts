      ...
      try {
        ...
        const htmlContent = `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            <h2 style="color: rgb(20, 59, 58);">Safemama Summary</h2>
            ${finalPatientName ? `<p><strong>Patient:</strong> ${finalPatientName}</p>` : ''}
            ${patientPhone ? `<p><strong>Phone:</strong> ${patientPhone}</p>` : ''}
            <div style="background-color: rgb(236, 239, 244); padding: 20px; border-radius: 8px; margin: 20px 0;">
              <h3 style="margin-top: 0; color: rgb(20, 59, 58);">Summary</h3>
              <p style="white-space: pre-wrap;">${summary}</p>
            </div>
            <p style="color: rgb(71, 85, 105); font-size: 12px; margin-top: 30px;">
